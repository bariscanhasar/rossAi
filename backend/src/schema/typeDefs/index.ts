...
type Mutation {
    ...
    register(firstName: String!, lastName:String!,email: String,password:String,keychain:String,isPremium:Boolean,deviceType:DeviceType,role:UserRoleEnum, isAgreementCheck: Boolean,subId:String): String
    ...
    anonRegister(deviceToken:String,deviceType:DeviceType,keychain:String,fcmId:String):String
